...
struct Object_
{
  ...
  _name_type name;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _support_surface_type;
  _support_surface_type support_surface;

   typedef std::vector< ::grasping_msgs::ObjectProperty_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::grasping_msgs::ObjectProperty_<ContainerAllocator> >> _properties_type;
...
struct Printer< ::grasping_msgs::Object_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::grasping_msgs::Object_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.support_surface);
